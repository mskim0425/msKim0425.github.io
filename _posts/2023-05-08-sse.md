...
title: "Spring SSE(Server-Sent Events) 구현 A to Z — SseEmitter 사용법, 타임아웃, 재연결, Nginx 주의점"
description: "Spring의 SseEmitter로 서버 푸시(SSE)를 구현하는 전 과정. 이벤트 전송, 타임아웃 설정, 클라이언트 재연결, Nginx 뒤에서 SSE를 쓸 때 주의점까지."
...
<img src ="/images/internet/sse형식.webp">
