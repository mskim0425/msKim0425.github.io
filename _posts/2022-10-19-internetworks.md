...
![image](/images/internet/1TCPIP와 OSI 7계층이 하는 역할을 간략하게 나타냄.webp){: .shadow }
...
![image](/images/internet/2DNS작동원리.webp)
...
![image](/images/internet/3httprequest.webp)
...
![image](/images/internet/4TCP IP HEADER.webp)
...
<img src="/images/internet/5_4 way handshake (connection close.webp">
...
![image](/images/internet/6 ARP 구도방식.webp)
...
#
 ![image](/images/internet/7 자주 사용되는 포트번호.webp)
