---
layout: post
title: "InnoDB란? — MySQL 기본 스토리지 엔진의 핵심 특징 정리 (버퍼 풀·클러스터드 인덱스·락·MVCC)"
description: "MySQL 기본 스토리지 엔진 InnoDB의 핵심 특징을 정리한다 — 버퍼 풀, 클러스터드 인덱스, 행 단위 락과 트랜잭션, MVCC."
date:   2023-02-06 11:01:04 +0900
categories: [Dev, Database]
tags: [mysql, innodb]
---
## Inno DB란? 
<img src="https://dev.mysql.com/doc/refman/8.0/en/images/mysql-architecture.webp">
...
<img src="https://dev.mysql.com/doc/refman/8.0/en/images/innodb-architecture-8-0.webp">
...
<img src="https://dev.mysql.com/doc/refman/8.0/en/images/innodb-change-buffer.webp">
